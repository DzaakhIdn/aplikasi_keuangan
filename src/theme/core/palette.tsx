...
// Grey color
type GreyChannel = `${keyof typeof themeConfig.palette.grey & number}Channel`;

export const grey = createPaletteChannel(themeConfig.palette.grey) as ReturnType<
  typeof createPaletteChannel<typeof themeConfig.palette.grey>
> &
  Record<GreyChannel, string>;
