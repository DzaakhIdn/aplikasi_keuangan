...
const MuiTableContainer: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiTable: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiTableRow: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiTableCell: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiTablePagination: ComponentConfig = {
  /** **************************************
   * DEFAULT PROPS
   *************************************** */
  defaultProps: {
