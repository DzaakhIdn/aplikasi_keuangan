...
const MuiInputBase: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiInput: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiOutlinedInput: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiFilledInput: ComponentConfig = {
  /** **************************************
   * DEFAULT PROPS
   *************************************** */
...
const MuiTextField: ComponentConfig = {
  /** **************************************
   * DEFAULT PROPS
   *************************************** */
