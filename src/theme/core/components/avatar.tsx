...
const avatarColors = {
  colors: COLORS.map((color) => ({
    props: ({ ownerState }: StyleParams) => ownerState.color === color,
  ...
  defaultColor: [
    {
      props: ({ ownerState }: StyleParams) => ownerState.color === 'default',
      style: ({ theme }: StyleParams) => ({
...
const MuiAvatar: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const MuiAvatarGroup: ComponentConfig = {
  /** **************************************
   * DEFAULT PROPS
   *************************************** */
  defaultProps: { max: 4 },
