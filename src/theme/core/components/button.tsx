...
import type { ComponentConfig, ComponentOwnerState, StyleParams } from './_types';
...
const MuiButtonBase: ComponentConfig = {
  /** **************************************
   * STYLE
   *************************************** */
  styleOverrides: {
...
const softVariant = {
  ...
  base: [
    {
      props: ({ ownerState }: StyleParams) => ownerState.variant === 'soft',
      style: ({ theme }: StyleParams) => ({
...
const MuiButton: ComponentConfig = {
  /** **************************************
   * DEFAULT PROPS
   *************************************** */
