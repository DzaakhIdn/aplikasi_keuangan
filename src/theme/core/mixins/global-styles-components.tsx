...
export interface PaperStylesOptions {
  blur?: number;
  color?: string;
  dropdown?: boolean;
}

export function paperStyles(theme: Theme, options?: PaperStylesOptions): CSSObject {
