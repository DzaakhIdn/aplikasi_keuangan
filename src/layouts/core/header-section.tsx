...
export type HeaderSectionSlots = {
  topArea?: ReactNode;
  leftArea?: ReactNode;
...
export type HeaderContainerProps = ContainerProps & {
  layoutQuery?: Breakpoint;
};

export type HeaderCenterAreaProps = ComponentPropsWithoutRef<'div'> & {
  sx?: SxProps<Theme>;
};

export type HeaderSectionSlotProps = {
  container?: HeaderContainerProps;
  centerArea?: HeaderCenterAreaProps;
};

export type HeaderSectionProps = Omit<AppBarProps, 'children' | 'slots' | 'slotProps'> & {
...
const HeaderRoot = styled(AppBar, {
  ...
  const pauseZindex: Record<'top' | 'bottom', number> = { top: -1, bottom: -2 };
...
const HeaderContainer = styled(Container, {
  shouldForwardProp: (prop) => prop !== 'layoutQuery' && prop !== 'sx',
