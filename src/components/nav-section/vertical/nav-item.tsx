...
import type { NavItemComponentProps, NavItemOwnerState } from '../types';
...
const shouldForwardProp = (prop: PropertyKey) =>
  !['open', 'active', 'disabled', 'variant', 'sx'].includes(String(prop));

/**
 * @slot root
 */
const ItemRoot = styled(ButtonBase, { shouldForwardProp })<NavItemOwnerState>(({ active, open, theme }) => {
 ...
 * @slot icon
 */
const ItemIcon = styled('span', { shouldForwardProp })<NavItemOwnerState>(() => ({
  ...navItemStyles.icon,
 ...
 * @slot texts
 */
const ItemTexts = styled('span', { shouldForwardProp })<NavItemOwnerState>((): CSSObject => ({
 ...
 * @slot title
 */
const ItemTitle = styled('span', { shouldForwardProp })<NavItemOwnerState>(({ theme }) => ({
 ...
 * @slot caption text
 */
const ItemCaptionText = styled('span', { shouldForwardProp })<NavItemOwnerState>(({ theme }) => ({
 ...
 * @slot info
 */
const ItemInfo = styled('span', { shouldForwardProp })<NavItemOwnerState>(() => ({
  ...navItemStyles.info,
}));
 ...
 * @slot arrow
 */
const ItemArrow = styled(Iconify, { shouldForwardProp })<NavItemOwnerState>(({ theme }) => ({
