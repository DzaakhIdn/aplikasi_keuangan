...
export function NavList({
  ...
  const isActive = data.path ? isActiveLink(pathname, data.path, !!data.children) : false;
...
type NavSubListProps = Omit<NavListProps, 'data'> & { data: readonly NavListProps['data'][] };
