...
export function InvoiceTableRow({
  ...
  const renderMenuActions = () => (
    ...
    >
      <MenuList>
        <li>
          <MenuItem component={RouterLink} href={detailsHref} onClick={menuActions.onClose} disabled={!detailsHref}>
  ...
  return (
    <>
              ...
              secondary={
                <Link
                  {...(detailsHref?.startsWith('http')
                    ? { href: detailsHref, target: '_blank', rel: 'noopener' }
                    : { component: RouterLink, href: detailsHref })}
                  color="inherit"
                >
                  {row.invoiceNumber}
                </Link>
      ...
      {!readOnly && renderMenuActions()}
      {!readOnly && renderConfirmDialog()}
    </>
  );
}
